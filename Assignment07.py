...
#   REidswick, 11/28/2025, Modified Script
# ------------------------------------------------------------------------------------------ #
import json
import _io
...
class Person:
    ...
    ChangeLog:
        - REidswick, 11/28/2025, created class
    """
    ...
    def first_name(self, value):
        if value.isalpha() or value == "":
            ...
            raise ValueError("First name must be alphabetic characters.")
    ...
    def last_name(self, value):
        if value.isalpha() or value == "":
            ...
            raise ValueError("Last name must be alphabetic characters.")
...
class FileProcessor:
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        try:
            ...
            for row in json_students:
                student_obj: Student = Student(first_name=row["FirstName"],
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        try:
            ...
            json.dump(list_of_dictionary_data, file, indent=3)
            file.close()
...
class IO:
    ...
    def output_student_and_course_names(student_data: list):
        ...
        for student in student_data:
            ...
            print("Student", student.first_name, student.last_name, "is enrolled in",
                  student.course_name)
    ...
    def input_student_data(student_data: list):
        ...
        try:
            ...
            student = Student()
            student.first_name = input("Please enter the first name: ")
            student.last_name = input("Please enter the last name: ")
